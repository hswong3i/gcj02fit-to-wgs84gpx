...
- **Version:** Synchronized version number to `20260809.1.3` across `VERSION`, `index.html`, `scss/base/_variables.scss`, `README.md`, and `DESIGN.md`.
